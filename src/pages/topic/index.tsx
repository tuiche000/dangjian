...
interface TableListProps extends FormComponentProps {
  dispatch: Dispatch<
    Action<
      | 'namespace_topic/add'
      | 'namespace_topic/fetch'
      | 'namespace_topic/remove'
      | 'namespace_topic/update'
    >
  >;
  loading: boolean;
  namespace_topic: StateType;
}
...
@connect(
  ({
    ...
    namespace_topic,
    loading: loading.models.namespace_topic,
  }),
)
