...
interface TableListProps extends FormComponentProps {
  dispatch: Dispatch<
    Action<
      | 'namespace_pointRule/add'
      | 'namespace_pointRule/fetch'
      | 'namespace_pointRule/remove'
      | 'namespace_pointRule/update'
    >
  >;
  loading: boolean;
  namespace_pointRule: StateType;
}
...
@connect(
  ({
    ...
    namespace_pointRule,
    loading: loading.models.namespace_pointRule,
  }),
)
class TableList extends Component<TableListProps, TableListState> {
  ...
  handleStandardTableChange = (
    ...
    dispatch({
      type: 'namespace_pointRule/fetch',
      payload: params,
    });
  };
  ...
  handleMenuClick = (e: { key: string }) => {
    ...
    switch (e.key) {
      case 'remove':
        ...
        let ids = arr.join();
        dispatch({
          type: 'namespace_pointRule/remove',
          payload: ids,
  ...
  handleUpdate = (fields: AddParams) => {
    const { dispatch } = this.props;
    dispatch({
      type: 'namespace_pointRule/update',
      payload: fields,
      callback: (res: ResParams2) => {
