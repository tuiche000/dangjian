...
interface TableListProps extends FormComponentProps {
  dispatch: Dispatch<
    Action<
      | 'namespace_banner/add'
      | 'namespace_banner/fetch'
      | 'namespace_banner/remove'
      | 'namespace_banner/update'
    >
  >;
  loading: boolean;
  namespace_banner: StateType;
}
...
@connect(
  ({
    ...
    namespace_banner,
    loading: loading.models.namespace_banner,
  }),
)
