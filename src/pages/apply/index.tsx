...
interface TableListProps extends FormComponentProps {
  dispatch: Dispatch<
    Action<
      | 'namespace_apply/add'
      | 'namespace_apply/fetch'
      | 'namespace_apply/remove'
      | 'namespace_apply/update'
    >
  >;
  loading: boolean;
  namespace_apply: StateType;
}
...
@connect(
  ({
    ...
    namespace_apply,
    loading: loading.models.namespace_apply,
  }),
)
